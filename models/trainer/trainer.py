...
class BaseTrainer(ABC):
    ...
    def full_eval(self, X_val, y_val):
        ...
        results["flat"] = metrics(flat_MAE_list, flat_MSE_list, flat_smoothness_loss_list)
        results["concat"] = metrics(concat_MAE_list, concat_MSE_list, concat_smoothness_loss_list)
        ...
        return results, (flat_xs, flat_ys, flat_preds), (concat_xs, concat_ys, concat_preds)
